...
_TaskHistoryModel _$TaskHistoryModelFromJson(Map<String, dynamic> json) =>
    $checkedCreate(
      '_TaskHistoryModel',
      json,
      ($checkedConvert) {
        final val = _TaskHistoryModel(
...
Map<String, dynamic> _$TaskHistoryModelToJson(_TaskHistoryModel instance) =>
    <String, dynamic>{
      'id': instance.id,
