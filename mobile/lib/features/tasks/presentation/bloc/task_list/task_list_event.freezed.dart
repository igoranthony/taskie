...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function()?  loaded,TResult Function()?  refreshed,TResult Function( TaskStatus? status,  TaskPriority? prioridade,  String? search,  int? criadoPor,  int? atribuidoPara,  DateTime? criadoEmInicio,  DateTime? criadoEmFim,  DateTime? dataLimiteInicio,  DateTime? dataLimiteFim,  String? projetoId,  String? colunaId,  bool semProjeto)?  filtered,TResult Function()?  loadedMore,TResult Function( String id)?  taskDeleted,TResult Function( Task task)?  taskUpdated,required TResult orElse(),}) {final _that = this;
switch (_that) {
case TaskListLoaded() when loaded != null:
return loaded();case TaskListRefreshed() when refreshed != null:
return refreshed();case TaskListFiltered() when filtered != null:
return filtered(_that.status,_that.prioridade,_that.search,_that.criadoPor,_that.atribuidoPara,_that.criadoEmInicio,_that.criadoEmFim,_that.dataLimiteInicio,_that.dataLimiteFim,_that.projetoId,_that.colunaId,_that.semProjeto);case TaskListLoadedMore() when loadedMore != null:
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function()?  loaded,TResult? Function()?  refreshed,TResult? Function( TaskStatus? status,  TaskPriority? prioridade,  String? search,  int? criadoPor,  int? atribuidoPara,  DateTime? criadoEmInicio,  DateTime? criadoEmFim,  DateTime? dataLimiteInicio,  DateTime? dataLimiteFim,  String? projetoId,  String? colunaId,  bool semProjeto)?  filtered,TResult? Function()?  loadedMore,TResult? Function( String id)?  taskDeleted,TResult? Function( Task task)?  taskUpdated,}) {final _that = this;
switch (_that) {
case TaskListLoaded() when loaded != null:
return loaded();case TaskListRefreshed() when refreshed != null:
return refreshed();case TaskListFiltered() when filtered != null:
...
class TaskListFiltered implements TaskListEvent {
  const TaskListFiltered({this.status, this.prioridade, this.search, this.criadoPor, this.atribuidoPara, this.criadoEmInicio, this.criadoEmFim, this.dataLimiteInicio, this.dataLimiteFim, this.projetoId, this.colunaId, this.semProjeto = false});
...
@override
int get hashCode => Object.hash(runtimeType,status,prioridade,search,criadoPor,atribuidoPara,criadoEmInicio,criadoEmFim,dataLimiteInicio,dataLimiteFim,projetoId,colunaId,semProjeto);

@override
String toString() {
  return 'TaskListEvent.filtered(status: $status, prioridade: $prioridade, search: $search, criadoPor: $criadoPor, atribuidoPara: $atribuidoPara, criadoEmInicio: $criadoEmInicio, criadoEmFim: $criadoEmFim, dataLimiteInicio: $dataLimiteInicio, dataLimiteFim: $dataLimiteFim, projetoId: $projetoId, colunaId: $colunaId, semProjeto: $semProjeto)';
}
...
@useResult
$Res call({
 TaskStatus? status, TaskPriority? prioridade, String? search, int? criadoPor, int? atribuidoPara, DateTime? criadoEmInicio, DateTime? criadoEmFim, DateTime? dataLimiteInicio, DateTime? dataLimiteFim, String? projetoId, String? colunaId, bool semProjeto
});
