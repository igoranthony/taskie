...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function()?  initial,TResult Function()?  loading,TResult Function( List<Task> tasks,  TaskStatus? filterStatus,  TaskPriority? filterPrioridade,  String? filterSearch,  int? filterCriadoPor,  int? filterAtribuidoPara,  DateTime? filterCriadoEmInicio,  DateTime? filterCriadoEmFim,  DateTime? filterDataLimiteInicio,  DateTime? filterDataLimiteFim,  String? projetoId,  String? colunaId,  bool semProjeto,  int page,  bool hasReachedMax,  bool isLoadingMore)?  success,TResult Function( String message)?  failure,required TResult orElse(),}) {final _that = this;
switch (_that) {
case TaskListInitial() when initial != null:
return initial();case TaskListLoading() when loading != null:
return loading();case TaskListSuccess() when success != null:
return success(_that.tasks,_that.filterStatus,_that.filterPrioridade,_that.filterSearch,_that.filterCriadoPor,_that.filterAtribuidoPara,_that.filterCriadoEmInicio,_that.filterCriadoEmFim,_that.filterDataLimiteInicio,_that.filterDataLimiteFim,_that.projetoId,_that.colunaId,_that.semProjeto,_that.page,_that.hasReachedMax,_that.isLoadingMore);case TaskListFailure() when failure != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function()  initial,required TResult Function()  loading,required TResult Function( List<Task> tasks,  TaskStatus? filterStatus,  TaskPriority? filterPrioridade,  String? filterSearch,  int? filterCriadoPor,  int? filterAtribuidoPara,  DateTime? filterCriadoEmInicio,  DateTime? filterCriadoEmFim,  DateTime? filterDataLimiteInicio,  DateTime? filterDataLimiteFim,  String? projetoId,  String? colunaId,  bool semProjeto,  int page,  bool hasReachedMax,  bool isLoadingMore)  success,required TResult Function( String message)  failure,}) {final _that = this;
switch (_that) {
case TaskListInitial():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function()?  initial,TResult? Function()?  loading,TResult? Function( List<Task> tasks,  TaskStatus? filterStatus,  TaskPriority? filterPrioridade,  String? filterSearch,  int? filterCriadoPor,  int? filterAtribuidoPara,  DateTime? filterCriadoEmInicio,  DateTime? filterCriadoEmFim,  DateTime? filterDataLimiteInicio,  DateTime? filterDataLimiteFim,  String? projetoId,  String? colunaId,  bool semProjeto,  int page,  bool hasReachedMax,  bool isLoadingMore)?  success,TResult? Function( String message)?  failure,}) {final _that = this;
switch (_that) {
case TaskListInitial() when initial != null:
return initial();case TaskListLoading() when loading != null:
return loading();case TaskListSuccess() when success != null:
...
@useResult
$Res call({
 List<Task> tasks, TaskStatus? filterStatus, TaskPriority? filterPrioridade, String? filterSearch, int? filterCriadoPor, int? filterAtribuidoPara, DateTime? filterCriadoEmInicio, DateTime? filterCriadoEmFim, DateTime? filterDataLimiteInicio, DateTime? filterDataLimiteFim, String? projetoId, String? colunaId, bool semProjeto, int page, bool hasReachedMax, bool isLoadingMore
});
